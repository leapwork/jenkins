...
public class Messages {
	...
	public static final String SCHEDULE_RUN_SUCCESS = "Schedule %1$s[%2$s] Trigerred Successfully";
	...
	public static final String CASE_STACKTRACE_FORMAT_BLOCK = "%1$s - %2$s - %3$s";
