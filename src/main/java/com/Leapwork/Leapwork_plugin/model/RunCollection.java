...
public final class RunCollection {
	...
	public void setPassedTests(int tests) {
		passedTests = tests;
	}

	public void addPassedTests(int tests) {
		passedTests += tests;
	}
	...
	public void setFailedTests(int failures) {
		failedTests = failures;
	}

	public void addFailedTests(int failures) {
		failedTests += failures;
	}
